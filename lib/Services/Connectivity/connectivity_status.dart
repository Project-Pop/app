...
class ConnectionStatus {
  ...
  /// by calling the `_internal` constructor specified below
  ...
  //   Because this is meant to exist
  //   through the entire application life cycle this isn't really an issue
  void dispose() {
